...
int main(int argc, char*argv[]){
    ...
    // main reason for creating a detached thread using this above method is so that its confirmed that we are creating detached thread and during destroy memory is freed
